...
retrieved_df = pd.read_csv("../data/train/retrieved_articles_new.csv")
...
output_df.to_csv("../data/train/retrieved_articles_text_new.csv", index=False)
print("✅ Saved retrieved_articles_text_new.csv with titles + content snippets.")
